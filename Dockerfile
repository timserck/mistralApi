...
# -----------------------------
    ...
    # Install latest CMake (ARM) to /opt/cmake
    RUN wget -O /tmp/cmake.sh https://github.com/Kitware/CMake/releases/download/v3.27.8/cmake-3.27.8-linux-aarch64.sh \
        && chmod +x /tmp/cmake.sh \
        && /bin/sh /tmp/cmake.sh --skip-license --prefix=/opt/cmake \
        && rm /tmp/cmake.sh
